...
// vai somar todas as idades
// 4. How many years did all the inventors live?
const totalYears = inventors.reduce((subtotal, b) => {
  return subtotal + (b.passed - b.year);
 }, 0);
...
// para ser feito no console quando estiver no site:
...
console.log("Lista em ordem alfabética: " , alpha);

// 8. Reduce Exercise
// Sum up the instances of each of these
const data = [
  'car', 'car', 'truck', 'truck', 'bola', 'bola', 'bola',
  'bike', 'walk', 'car', 'van', 'bike', 'avião', 'avião',
  'walk', 'car', 'van', 'car', 'truck', 'pogostick', 'bola'
];

const itens = data.reduce((obj, item) => {
  if (!obj[item]) {
    obj[item] = 0;
  }
    obj[item]++;
